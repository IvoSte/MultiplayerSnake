...
from controls.input_controls import controllerInputHandler, inputHandler, Controls, player_1_controls, player_2_controls, general_controls, player_3_controls, player_4_controls
from game.env_variables import BACKGROUND_VISUALS, DISABLE_MUSIC, FREEZE_FRAMES_ON_EAT, GAME_TIMER, GAME_TIMER_SWITCH, INITIAL_FOOD, NUMBER_OF_PLAYERS, INITIAL_LIVES, SCREEN_SIZE_X, SCREEN_SIZE_Y, \
