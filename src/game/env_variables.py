...
# Music
MUSIC_PATH = os.path.join('assets', 'audio', 'music', 'track_1_loop.wav') #os.path.join('assets', 'audio', 'soundFX', "track_1_loop.wav"
...
PLAYER_1_EAT_FRUIT_SOUNDS = [os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_1_C.wav"),  os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_2_D.wav"), os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_3_E.wav"), os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_4_G.wav"), os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_5_A.wav"), os.path.join('assets', 'audio', 'soundFX', "1_pickupsound_6_C.wav")]
PLAYER_2_EAT_FRUIT_SOUNDS = [os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_1_C.wav"),  os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_2_D.wav"), os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_3_E.wav"), os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_4_G.wav"), os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_5_A.wav"), os.path.join('assets', 'audio', 'soundFX', "2_pickupsound_6_C.wav")]
