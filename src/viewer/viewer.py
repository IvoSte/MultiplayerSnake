...
from game.env_variables import FULLSCREEN, GAME_TIMER, GAME_TIMER_SWITCH, PLAYER_SCORE_BOXES, RESOLUTION_SCALE, SCREEN_SIZE_X, SCREEN_SIZE_Y, SNAKE_SIZE, TICKS_PER_SECOND, VERZET, BACKGROUND_VISUALS
...
class Viewer():
    ...
    def draw_game(self, game):
        ...
        # Update score
        self.ui_player_information.display_players_information(game.players)
