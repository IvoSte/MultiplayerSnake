...
class Viewer():
    def __init__(self, snake_size=(10,10), display_size=(600,400), game_title="Multiplayer Snake Game - Extraordinaire"):
        ...
        self.score_font = pygame.font.SysFont("futura", 25)
    ...
    def display_players_score(self, players):
        positions = [[0,0],[0,20],[0,40],[0,60]]
        for idx, player in enumerate(players):
            self.display_player_score(player, positions[idx])
